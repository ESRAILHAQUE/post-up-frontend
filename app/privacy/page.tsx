            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  providers who help us operate our business (e.g., payment processors, hosting providers), and with
                  publishers as necessary to fulfill your orders.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  If you have questions about this privacy policy, please contact us at privacy@postup.com
                </p>
              </div>
            </div>
          </div>
