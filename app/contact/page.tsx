          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Have questions? We're here to help you succeed with your guest posting strategy
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="space-y-6">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <a href="mailto:hello@postup.com" className="text-primary hover:underline font-medium">
                      hello@postup.com
                    </a>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm font-medium">Available Mon-Fri, 9am-5pm EST</p>
                  </CardContent>
                </Card>
