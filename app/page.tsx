  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <Badge variant="secondary" className="mb-2 bg-emerald-500/20 text-emerald-300 border-emerald-500/30">
                Trusted by 500+ Businesses
              </Badge>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-balance">
                Premium Guest Posts on <span className="text-emerald-400">High Authority Sites</span>
              </h1>
              <p className="text-xl text-slate-300 leading-relaxed text-pretty">
                Boost your SEO and build quality backlinks with our curated network of high-DA websites. Get published
                on authoritative sites in your niche.
              </p>
              ...
              <div className="pt-6">
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <span className="text-xs text-slate-300">4.8 out of 5 on Trustpilot</span>
                  </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-700/50">
                ...
                <div className="absolute top-6 right-6 bg-slate-900/95 backdrop-blur-sm rounded-lg p-4 shadow-lg border border-slate-700">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-sm font-semibold text-white">Traffic Growth</span>
                  </div>
                ...
                <div className="absolute bottom-6 left-6 bg-slate-900/95 backdrop-blur-sm rounded-lg p-4 shadow-lg border border-slate-700">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-sm font-semibold text-white">DA Score</span>
                  </div>
      ...
      <section id="sites" className="py-20 bg-slate-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">Featured Guest Post Opportunities</h2>
                ...
                <CardContent className="flex-1 pb-3">
                  <div className="space-y-1.5 text-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-slate-900">{site.monthly_traffic.toLocaleString()}/mo</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-slate-600">Delivery</span>
                      <span className="font-semibold text-slate-900">{site.turnaround_days} days</span>
                    </div>
                    <div className="flex items-center justify-between pt-2 border-t border-slate-200">
                      <span className="text-slate-600">Price</span>
                      <span className="text-xl font-bold text-emerald-600">${site.price}</span>
                    </div>
                  </div>
                </CardContent>
      ...
      <section className="py-20 bg-background">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose PostUp?</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  "PostUp helped us secure backlinks from sites we could never reach on our own. Our organic traffic
                  increased by 150% in 3 months."
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Marketing Director, TechCo</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  "The quality of sites and the speed of delivery exceeded our expectations. This is now our go-to for
                  link building."
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">SEO Manager, GrowthLabs</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  "We've tried other services, but PostUp's quality and transparency are unmatched. Highly recommend for
                  serious marketers."
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Founder, ContentScale</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="border border-border rounded-lg px-6 bg-card">
                <AccordionTrigger className="text-left hover:no-underline py-5">
                  <span className="text-lg font-semibold">What is a guest post?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                  A guest post is an article you publish on another website to build backlinks, increase brand
                  awareness, and drive traffic to your site. It's one of the most effective SEO strategies for improving
                  search rankings.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2" className="border border-border rounded-lg px-6 bg-card">
                <AccordionTrigger className="text-left hover:no-underline py-5">
                  <span className="text-lg font-semibold">How do you verify site quality?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                  We manually review every site for domain authority (DA), domain rating (DR), organic traffic, spam
                  score, and editorial quality. Only sites that meet our strict criteria are added to our marketplace.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3" className="border border-border rounded-lg px-6 bg-card">
                <AccordionTrigger className="text-left hover:no-underline py-5">
                  <span className="text-lg font-semibold">How long does it take to get published?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                  <div className="pt-0 text-muted-foreground leading-relaxed pb-5">
                    Most guest posts are published within 25-30 days. The exact turnaround time is listed on each site's
                    page. You can track your order status in real-time through your dashboard.
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4" className="border border-border rounded-lg px-6 bg-card">
                <AccordionTrigger className="text-left hover:no-underline py-5">
                  <span className="text-lg font-semibold">Do you offer refunds if I'm not satisfied?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                  <div className="pt-0 text-muted-foreground leading-relaxed pb-5">
                    We offer a 30-day satisfaction guarantee. If you're not completely satisfied with our service, we'll
                    work to make it right or provide a full refund.
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5" className="border border-border rounded-lg px-6 bg-card">
                <AccordionTrigger className="text-left hover:no-underline py-5">
                  <span className="text-lg font-semibold">Are the backlinks dofollow or nofollow?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                  Most of our sites provide dofollow backlinks, which pass SEO value to your website. The link type is
                  clearly indicated on each site's listing page before you purchase.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-6" className="border border-border rounded-lg px-6 bg-card">
                <AccordionTrigger className="text-left hover:no-underline py-5">
                  <span className="text-lg font-semibold">Do you guarantee the guest posts will be permanent?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                  <div className="pt-0 text-muted-foreground leading-relaxed pb-5">
                    Yes, all our guest posts come with a permanent placement guarantee. If a post is removed within the
                    first 12 months, we'll replace it at no additional cost.
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-7" className="border border-border rounded-lg px-6 bg-card">
                <AccordionTrigger className="text-left hover:no-underline py-5">
                  <span className="text-lg font-semibold">Can I order multiple guest posts at once?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                  Many of our clients order multiple guest posts across different sites to build a diverse backlink
                  profile. Contact our sales team for volume discounts on bulk orders.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-8" className="border border-border rounded-lg px-6 bg-card">
                <AccordionTrigger className="text-left hover:no-underline py-5">
                  <span className="text-lg font-semibold">How do I get started?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed pb-5">
                  Simply browse our marketplace, select a site that matches your niche, and place your order. You'll
                  provide your content and target URL during checkout. Our team handles the rest!
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">Ready to Boost Your SEO?</h2>
            <p className="text-xl text-primary-foreground/90 leading-relaxed">
              Start building high-quality backlinks today and watch your rankings soar
            </p>
